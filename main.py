...
import os
import logging
import json # Added for json.dumps in logging
...
# For Cloud Run, variables are injected directly.
...
# For local testing, run with: uvicorn main:app --reload --port 8080
# For Cloud Run, this file serves as the entrypoint.
